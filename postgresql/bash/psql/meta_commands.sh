#!/usr/bin/env bash
# ==============================================================================
# DOCUMENTATION: meta-commands.md
...
- [../../../linux/bash/commands/psql/connect.md](../../../linux/bash/commands/psql/connect.sh) —
  connecting from the command line
- [../../../linux/bash/commands/psql/create-extension.md](../../../linux/bash/commands/psql/create_extension.sh) —
